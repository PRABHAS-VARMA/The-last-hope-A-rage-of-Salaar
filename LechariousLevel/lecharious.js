...
const background = new Sprite({
  ...
  imageSrc: '../backgroundImg/valeorg.png'
})
...
const enemy = new Fighter({
  ...
  imageSrc: '../img/EVil Wizard 2/EVil Wizard 2/Sprites/Idle.png',
  framesMax: 8,
  scale: 2.5,
  offset: {
    x: 215,
  ...
  sprites: {
    ...
    fall: {
      imageSrc: '../img/EVil Wizard 2/EVil Wizard 2/Sprites/Fall.png',
      framesMax: 2
    },
    attack1: {
      imageSrc: '../img/EVil Wizard 2/EVil Wizard 2/Sprites/Attack1.png',
      framesMax: 8
    },
    takeHit: {
      imageSrc: '../img/EVil Wizard 2/EVil Wizard 2/Sprites/Take hit.png',
      framesMax: 3
    },
    death: {
      imageSrc: '../img/EVil Wizard 2/EVil Wizard 2/Sprites/Death.png',
      framesMax: 7
    }
  },
  attackBox: {
