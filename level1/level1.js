...
const enemy = new Fighter({
  ...
  imageSrc: '../img/FantasyWarrior/FantasyWarrior/Sprites/Monsters_Creatures_Fantasy/Mushroom/Idle.png',
  framesMax: 4,
  scale: 2.5,
  offset: {
    x: 215,
  ...
  sprites: {
    ...
    attack1: {
      imageSrc: '../img/FantasyWarrior/FantasyWarrior/Sprites/Monsters_Creatures_Fantasy/Mushroom/Attack.png',
      framesMax: 8
    },
    takeHit: {
      imageSrc: '../img/FantasyWarrior/FantasyWarrior/Sprites/Monsters_Creatures_Fantasy/Mushroom/Take Hit.png',
      framesMax: 4
    },
    death: {
      imageSrc: '../img/FantasyWarrior/FantasyWarrior/Sprites/Monsters_Creatures_Fantasy/Mushroom/Death.png',
      framesMax: 4
    }
  },
  attackBox: {
