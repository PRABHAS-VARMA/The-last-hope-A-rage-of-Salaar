...
const background = new Sprite({
  ...
  imageSrc: '../backgroundImg/vale.png'
})
...
const enemy = new Fighter({
  ...
  imageSrc: '../img/FantasyWarrior/FantasyWarrior/Sprites/Monsters_Creatures_Fantasy/Flying eye/Flight.png',
  framesMax: 4,
  scale: 2.5,
  offset: {
    x: 215,
  ...
  sprites: {
    ...
    attack1: {
      imageSrc: '../img/FantasyWarrior/FantasyWarrior/Sprites/Monsters_Creatures_Fantasy/Flying eye/Attack.png',
      framesMax: 8
    },
    takeHit: {
      imageSrc: '../img/FantasyWarrior/FantasyWarrior/Sprites/Monsters_Creatures_Fantasy/Flying eye/Take Hit.png',
      framesMax: 4
    },
    death: {
      imageSrc: '../img/FantasyWarrior/FantasyWarrior/Sprites/Monsters_Creatures_Fantasy/Flying eye/Death.png',
      framesMax: 4
    }
  },
  attackBox: {
